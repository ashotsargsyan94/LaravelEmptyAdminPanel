...
class PagesController extends BaseController
{
    private function content_pages(){
        return [
            ...
            'contact'=>route('admin.banners', ['page'=>'contact']),
            'menu'=>route('admin.banners', ['page'=>'menu']),
            'projects'=>route('admin.banners', ['page'=>'projects']),
            'services'=>route('admin.banners', ['page'=>'services']),
            'news'=>route('admin.banners', ['page'=>'news']),
            'partners'=>route('admin.banners', ['page'=>'partners']),
        ];
    }
    ...
    private function gallery_pages(){
        return [
            ...
            'estates'=>route('admin.gallery', ['gallery'=>'estates']),
            'services_item'=>route('admin.gallery', ['gallery'=>'services_item']),
