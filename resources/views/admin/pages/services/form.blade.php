...
@section('content')
    <form action="{!! $edit?route('admin.services.edit', ['id'=>$item->id]):route('admin.services.add') !!}" method="post"
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    <div class="c-title">Иконка (60x60)</div>
                    @if (!empty($item->image))
                        <div class="p-2 text-center">
                            <img src="{{ asset('u/services/'.$item->image) }}" alt="" class="img-responsive">
                        </div>
                    @endif
                    <div class="c-body">
