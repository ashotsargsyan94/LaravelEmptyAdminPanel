...
<form action="{!! $edit?route('admin.pages.edit', ['id'=>$page->id]):route('admin.pages.add') !!}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-12 col-lg-6">
            ...
            @if (!$edit || !$page->static)
                <div class="card">
                    <div class="c-title">Изоброжение 16:3 (1440x270)</div>
                    @if (!empty($page->image))
                    ...
                    <div class="c-body">
                        ...
                        @labelauty(['id'=>'show_image', 'label'=>'Показать изоброжение', 'class'=>'mt-2', 'checked'=>oldCheck('to_menu', ($edit && empty($page->show_image))?false:true)])@endlabelauty
                    </div>
                </div>
            @endif
        </div>
