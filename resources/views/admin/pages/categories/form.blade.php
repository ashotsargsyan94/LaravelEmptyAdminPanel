...
@section('content')
<form action="{!! $edit?route('admin.categories.edit', ['id'=>$item->id]):route('admin.categories.add') !!}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="card">
                <div class="c-title">Изоброжение 4:3 (400x300)</div>
                @if (!empty($item->image))
                    <div class="p-2 text-center">
                        <img src="{{ asset('u/categories/'.$item->image) }}" alt="" class="img-responsive">
                    </div>
                @endif
                <div class="c-body">
